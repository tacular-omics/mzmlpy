...
def test_instrument_configuration(filename):
    ...
    assert config.get_cv_param("MS:1000554").name == "LCQ Deca"
    assert config.get_cv_param("MS:1000529").value == "23433"
